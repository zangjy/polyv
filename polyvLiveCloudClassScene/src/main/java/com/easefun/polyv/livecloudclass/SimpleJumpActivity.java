...
import com.easefun.polyv.livecommon.YMConsUtil;
...
public class SimpleJumpActivity extends Activity {
     ...
     * @param showViewerCount 是否展示观看人数
     * @return
     */
    public static Intent createIntent(Context context,
        ...
        intent.putExtra(YMConsUtil.SHOW_VIEWER_COUNT_KEY, showViewerCount);
        return intent;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //保存是否展示观看人数
        SPUtils.getInstance(YMConsUtil.DEFAULT_SP_NAME).put(
                YMConsUtil.SHOW_VIEWER_COUNT_KEY,
                intent.getBooleanExtra(YMConsUtil.SHOW_VIEWER_COUNT_KEY, true),
                true
        );
        ...
        plvSceneLoginManager.loginLiveNew(appId, appSecret, userId, channelId, new IPLVSceneLoginManager.OnLoginListener<PLVLiveLoginResult>() {
            ...
            public void onLoginSuccess(PLVLiveLoginResult plvLiveLoginResult) {
                ...
                if (PLVLiveScene.isCloudClassSceneSupportType(channelType)) {
                    PLVLaunchResult launchResult = PLVLCCloudClassActivity.launchLive(SimpleJumpActivity.this, channelId, channelType, viewerId, viewerName, viewerAvatar, PLVLiveClassDetailVO.LangType.LANG_TYPE_FOLLOW_SYSTEM);
    ...
    private void loginPlaybackNew(final String appId, final String appSecret, final String userId, final String channelId, final String videoId) {
        plvSceneLoginManager.loginPlaybackNew(appId, appSecret, userId, channelId, videoId, new IPLVSceneLoginManager.OnLoginListener<PLVPlaybackLoginResult>() {
            ...
            public void onLoginSuccess(PLVPlaybackLoginResult plvPlaybackLoginResult) {
                ...
                if (PLVLiveScene.isCloudClassSceneSupportType(channelType)) {
                    PLVLaunchResult plvLaunchResult = PLVLCCloudClassActivity.launchPlayback(SimpleJumpActivity.this, channelId, channelType, videoId, null, viewerId, viewerName, viewerAvatar, PLVPlaybackListType.PLAYBACK, PLVLiveClassDetailVO.LangType.LANG_TYPE_FOLLOW_SYSTEM);
