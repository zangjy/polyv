...
public class PLVLCLiveMediaController extends FrameLayout implements IPLVLCLiveMediaController, View.OnClickListener {
    ...
    public void updateViewerCount(long viewerCount) {
        boolean showViewer = SPUtils.getInstance(YMConsUtil.DEFAULT_SP_NAME).getBoolean(YMConsUtil.SHOW_VIEWER_COUNT_KEY, true);

        videoViewerCountPortTv.setVisibility(showViewer ? View.VISIBLE : View.INVISIBLE);
        videoViewerCountLandTv.setVisibility(showViewer ? View.VISIBLE : View.INVISIBLE);
